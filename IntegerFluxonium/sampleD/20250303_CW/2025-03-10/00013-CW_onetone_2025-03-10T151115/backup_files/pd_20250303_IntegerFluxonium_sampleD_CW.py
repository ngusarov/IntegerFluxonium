...
param_dict = {
    ...
    "CW_onetone":{
        ...
        "ro_freq_npts":31, # if "False", npts is calculated using ro_freqstep
    ...
    "CW_twotone":{
        ...
        "qu_freq_start": 3.53e9,#qu_freq,# - 800e6 , # [Hz]
        "qu_freq_stop": 3.61e9, #qu_freq + 20e6, #qu_freq+300e6, # [Hz]
        "qu_freq_npts":False, # if "False", npts is calculated using ro_freqstep

        "sweep":"qu_power",#"index", # str. name of the sweep parameter
    },
    ...
    # current
    #"sweep_start":-0.0e-6,#-506e-6,
    #"sweep_stop": 10.0e-6,#-456e-6,
    #"sweep_npts": 11,#51,
    #"sweep_list":False, #[10*np.log10(p_mW) for p_mW in np.linspace(0.001, 0.002, 10)], 
