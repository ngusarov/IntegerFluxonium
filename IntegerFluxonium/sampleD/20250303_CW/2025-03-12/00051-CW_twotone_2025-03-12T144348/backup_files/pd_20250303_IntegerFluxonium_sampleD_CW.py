...
param_dict = {
    ...
    "CW_onetone":{
        ...
        "ro_freq_stop":ro_freq, # [Hz] must be larger than start
    ...
    #### CW twotone ####
    "CW_twotone":{
        "qu_freq_step":1e6,#5e6, # [Hz]
        "qu_freq_start": 3.600e9,#qu_freq,# - 800e6 , # [Hz]
        "qu_freq_stop": 3.800e9, #qu_freq + 20e6, #qu_freq+300e6, # [Hz]
        "qu_freq_npts":False, # if "False", npts is calculated using ro_freqstep

        "sweep":False,#"index", # str. name of the sweep parameter
    },
    ...
    # current
    #"sweep_start":-600.0e-6,#-506e-6,
    #"sweep_stop": -200.0e-6,#-456e-6,
    #"sweep_npts": 101,#51,
    #"sweep_list":False, #[10*np.log10(p_mW) for p_mW in np.linspace(0.001, 0.002, 10)], 
