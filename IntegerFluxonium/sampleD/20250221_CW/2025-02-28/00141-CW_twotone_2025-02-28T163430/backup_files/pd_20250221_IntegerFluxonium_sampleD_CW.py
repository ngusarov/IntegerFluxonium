...
param_dict = {
    ...
    #### CW twotone ####
    "CW_twotone":{
        "qu_freq_step":2e6,#5e6, # [Hz]
        "qu_freq_start": 3.4e9,#qu_freq,# - 800e6 , # [Hz]
        "qu_freq_stop": 3.8e9, #qu_freq + 20e6, #qu_freq+300e6, # [Hz]
    ...
    "sweep_stop":-650.4e-6,#-506e-6,
    "sweep_start": -450.4e-6,#-456e-6,
    "sweep_npts": 403,#51,
    "sweep_list":False, #[10*np.log10(p_mW) for p_mW in np.linspace(0.001, 0.002, 10)], 
