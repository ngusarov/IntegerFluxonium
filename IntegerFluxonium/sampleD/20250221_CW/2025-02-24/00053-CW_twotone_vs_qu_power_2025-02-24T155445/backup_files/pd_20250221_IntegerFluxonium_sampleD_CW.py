...
ro_freq = 7.4644e9 #[Hz]
# qu_freq = 3.790e9 #[Hz]
qu_freq = 3.692e9 #[Hz] # for "current":-495.826e-6, # [A]
qu_freq02_by2 = 0
freq_03 = 0
# freq_05 = 0
...
param_dict = {
    ...
    #### CW twotone ####
    "CW_twotone":{
        "qu_freq_step":5e6,#0.05e6, # [Hz]
        "qu_freq_start": qu_freq,# - 800e6 , # [Hz]
        "qu_freq_stop":qu_freq + 20e6, #qu_freq+300e6, # [Hz]
        "qu_freq_npts":1, # if "False", npts is calculated using ro_freqstep

        "sweep":"qu_power", # str. name of the sweep parameter
    },
    ...
    # current
    #"sweep_start":-506e-6,
    #"sweep_stop": -456e-6,#-40
    #"sweep_npts":51,#10
    #"sweep_list":False, #[10*np.log10(p_mW) for p_mW in np.linspace(0.001, 0.002, 10)], 
    
    
    # ro_freq
    #"sweep_start":7.4644e9 - 50e6,
    #"sweep_stop": 7.4644e9 + 50e6,#-40
    #"sweep_npts":51,#10
    #"sweep_list":False, #[10*np.log10(p_mW) for p_mW in np.linspace(0.001, 0.002, 10)], 
